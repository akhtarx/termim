class Termim < Formula
  ...
  url "https://github.com/akhtarx/termim/archive/refs/tags/v1.2.4.tar.gz"
  # Note: When releasing v1.2.4, update this SHA256 checksum with the value of the release tarball.
  # You can find it by running: curl -sSL https://github.com/akhtarx/termim/archive/refs/tags/v1.2.4.tar.gz | sha256sum
